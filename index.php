        ...
        <section class="wpo-hero-slider wpo-hero-style-3">
            <div class="wedding-announcement">
                <div class="couple-text">
                    ...
                    <p class="wow slideInUp" data-wow-duration="1.8s">We Are Getting Married Nov 22,2021</p>
        ...
        <footer class="wpo-site-footer">
            ...
            <div class="wpo-lower-footer">
                <div class="container">
                    <div class="row">
                        <div class="col col-xs-12">
                            <p class="copyright"> &copy; 2024 Loveme Template. Design By <a
                                    href="https://frogbid.com/" target="_blank">FrogBID</a>. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
